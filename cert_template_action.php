...
if (!$template) {
    redirect(
        $listurl, get_string('cert_template_action_err_notallowed', 'local_rtocompliance'),
...
switch ($action) {
    case 'submit':
        ...
        redirect(
            new moodle_url('/local/rtocompliance/cert_template_edit.php', ['id' => $id]),
    ...
    case 'activate':
        ...
        redirect(
            $listurl, get_string('cert_template_action_ok_activated', 'local_rtocompliance'),
            null, \core\output\notification::NOTIFY_SUCCESS);
        break;
    ...
    case 'archive':
        ...
        redirect(
            $listurl, get_string('cert_template_action_ok_archived', 'local_rtocompliance'),
            null, \core\output\notification::NOTIFY_SUCCESS);
        break;
    ...
    case 'deactivate':
        ...
        redirect(
            $listurl, get_string('cert_template_action_ok_deactivated', 'local_rtocompliance'),
            null, \core\output\notification::NOTIFY_SUCCESS);
        break;
    ...
    case 'delete':
        ...
        redirect(
            $listurl, get_string('cert_template_action_ok_deleted', 'local_rtocompliance'),
            null, \core\output\notification::NOTIFY_SUCCESS);
        break;
