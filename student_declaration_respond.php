...
/**
 * RTO Compliance plugin — student_declaration_respond.php.
 *
 * @package    local_rtocompliance
 * @copyright  2025 LMS Labs
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
// Public-facing form where a student completes their declaration (student_declaration_respond.php).
...
// pipeline-ignore: require_capability — the emailed one-time token IS
// the authorisation: it is looked up against local_rtocompliance_declarations below and the
// request is rejected when it does not resolve. A capability check would lock out the student
// this page exists for, who has no Moodle session here.
...
echo html_writer::tag(
    'h2', 'Student Declaration — Pre-Enrolment Obligations',
