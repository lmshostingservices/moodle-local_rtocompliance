...
function local_rtocompliance_faq_data(): array {
    return [
        ...
        ['cat' => 'USI verification', 'icon' => 'shield', 'items' => [
            ...
            ['q' => 'USI verification fails with error E2003 ("relying party not recognised") — how do I fix it?', 'a' => 'This is a fault in the lms-labs.com platform, not something you can fix and not a problem with your credential or your ATO setup. Please report it to lms-labs.com support. Do NOT contact the ATO or RAM about E2003 — there is no setting in ATO Access Manager that authorises a machine credential for the USI Registry, so that call cannot help. Re-uploading your credential will not change it either. Earlier advice from this plugin that pointed to ATO Access Manager was incorrect and has been withdrawn.', 'page' => 'usi_settings.php'],
        ]],
