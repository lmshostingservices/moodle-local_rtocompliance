...
$string['nominalhours_enter_code_first'] = 'Enter a code first (e.g. BSB50420 or BSBWHS411).';
...
$string['nominalhours_lookup_title'] = 'Automatically fetch nominal hours from NCVER for this code';
$string['nominalhours_looking_up_btn'] = 'Looking up...';
$string['nominalhours_source_ncver'] = 'NCVER';
$string['nominalhours_source_rto'] = 'RTO Compliance';
