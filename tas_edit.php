...
document.addEventListener("DOMContentLoaded", function (){
    ...
    if(parsed && parsed.v===2 && Array.isArray(parsed.selected)){
        ...
        $mform->setType('identityverification', PARAM_RAW);
        ...
        $mform->setType('academicintegrity', PARAM_RAW);
        ...
        $mform->setType('rplpathway', PARAM_RAW);
        ...
        $mform->setType('trainerunitmapping', PARAM_RAW);
